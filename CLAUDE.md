...
| `POST /api/applications/:id/ai/letter-versions/save` | Appends `{ subject, body, createdAt }` to `aiResultsCache["letter-versions"].versions`; returns the list |
